...
import {getProduct, getCategories, updateProduct} from './apiAdmin.js'
...
const UpdateProduct = ({match}) => {
    ...
    const addProductForm = () => (
        <form className="mb-3">
           ...
           <button onClick={handleSubmit} type="sumbit" className="btn btn-primary">Update product</button>
        </form>
    )
